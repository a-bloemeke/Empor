...
const features: Feature[] = [
  ...
  { icon: "🍺", title: "Bier mitbringen", body: "Nur für angemeldete Spieler: Mit „Bier mitbringen 🍺“ trägst du dich als Bier-Bringer ein. Pro Spieltag gibt es genau einen. Der Button erscheint nur, solange noch niemand übernommen hat – ist bereits jemand eingetragen, siehst du nur den Namen (z. B. „🍺 Max“) und kannst ihn nicht überschreiben. Änderungen macht nur der Organisator. Erneuter Klick trägt dich selbst wieder aus." },
  { icon: "🏖️", title: "Abwesenheit / Urlaub eintragen", body: "Länger verhindert? Trage in deinem Profil unter „Abwesenheiten“ einen Zeitraum (Start-/Enddatum, optional Grund wie „Urlaub“) ein. In dieser Zeit wirst du auf den „Keine Antwort“-Listen der Organisatoren ausgeblendet und bekommst keine Nachfragen. Einträge kannst du jederzeit wieder löschen." },
